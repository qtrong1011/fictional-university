...
function EditComponent(props) {
  ...
  function updateTheMeta() {
    const profsForMeta = wp.data.select('core/block-editor').getBlocks().filter(x => x.name == "ourplugin/featured-professor").map(x => x.attributes.professorId).filter((x, index, arr) => {
  ...
  if (allProfs == undefined) {
    ...
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("option", {
        value: prof.id,
        selected: props.attributes.professorId == prof.id
      }, prof.title.rendered);
    }))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
